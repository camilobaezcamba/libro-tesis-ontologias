...
\begin{description}
    ...
    \item[O2.] Aplicar un proceso de modelado de una ontología, utilizando una base de representación de conocimiento de dominio.
...
\begin{description}
    ...
    \item[C5.] \label{contrib:6}Verificación parcial de la adecuación de la representación de datos disponinilizada por la DNCP.
