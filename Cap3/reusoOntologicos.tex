...
\begin{table}[!htb]
    ...
    \hline
     & LOTED & LOTED2 & PCO & PPROC & DNCP \\
    \hline

    
    Cantidad de Axiomas & 172 & 1709 & 450 & 1501 & 802\\
    \hline

    Cantidad de Clases & 23 & 177 & 22 & 92 & 36\\
    \hline

    Lenguaje & OWL (RDF/XML) & OWL (RDF/XML) & OWL (RDF/XML) & OWL (RDF/XML) & OWL (RDF/XML)\\
    \hline
    Metodología & Propia & 
    Un enfoque de arriba hacia abajo (extracción de conceptos jurídicos de fuentes legales) y en una de abajo hacia arriba (análisis de las formas estándar).
     & Propia & Ontology Development 101 & Propia\\
     \hline
    Cantidad de ontologías reutilizadas & 2 (DBpedia, geonames) & 2 & 7 & 6 & 0\\
    \hline
    ...
    semánticas en las herramientas utilizadas por las Administraciones públicas en los procesos de contratación & Base de conocimiento de datos de contrataciones públicas de Paraguay \\
    \hline
    Ultima versión & 03 Jul. 2012 & 24 Jul. 2013 & 10 Oct. 2012 & (1.0.0)29 Oct. 2014 & 2016\\
    \hline
    \end{tabular}
...
\begin{table}[!htb]
    ...
    Cantidad de Axiomas & 1210 \\
    \hline

    Cantidad de Clases & 36 \\
    \hline

    Lenguaje & OWL (RDF/TTL) \\
    \hline
    Metodología & NeON \\
     \hline
    Cantidad de ontologías reutilizadas & 6\\
    \hline
    Propósito de la ontología & Agregar un nivel de semántico al OCDS \\
    \hline
    Ultima versión & 07 Nov. 2018 \\
    \hline
    \end{tabular}
