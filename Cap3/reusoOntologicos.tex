...
Para los documentos correspondientes a cada fase del proceso licitatorio se hizo una especialización de la clase Document, siendo así una subclase del mismo. Por lo tanto tenemos el enunciado del cuadro  \ref{lst:sparql1}
...
:Document rdf:type owl:Class ;
 ...
 Al mismo tiempo se reutilizaron de la ontología Public Contract, los conceptos de Tender y Contract de un proceso licitatorio(cuadro \ref{lst:sparql2})
...
:Contract rdf:type owl:Class ;
 ...
 Good Relations es una ontología para modelar compras de bienes y servicios a través de internet, por lo que también se procedió a la reutilización de los conceptos gr:Offering, gr:BusinessEntity y gr:PriceSpecification (cuadro \ref{lst:sparql3})
...
:Value rdf:type owl:Class ;
 ...
 Se reutilizó la ontología de Schema.org para conceptos básicos como los presentados el cuadro \ref{lst:sparql4}.
...
:ContactPoint rdf:type owl:Class ;
 ...
 Además se utilizó la ontología Sequence para modelar la relación de secuencia que existe dentro del proceso licitatorio. En el cuadro \ref{lst:sparql5} muestra como ejemplo la propiedad que indica que la Planificación precede directamente al Llamado.
