...
\begin{lstlisting}[captionpos=b, caption={Información referente al proceso licitatorio cuyo identificacores}, label={lst:caso2},  numbers=left,  numberstyle=\tiny\color{mygray},
...
SELECT  *
 ...
 \begin{lstlisting}[captionpos=b, caption=Información referente al proceso licitatorio cuyo identificacor es, label=lst:caso2-2,  numbers=left,  numberstyle=\tiny\color{mygray},
    basicstyle=\tiny,frame=single]
